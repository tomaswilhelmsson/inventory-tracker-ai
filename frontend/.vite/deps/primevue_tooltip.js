...
var Tooltip = BaseTooltip.extend("tooltip", {
  beforeMount: function beforeMount(el, options) {
    ...
    } else if (_typeof3(options.value) === "object" && options.value) {
  ...
  methods: {
    ...
    create: function create(el) {
      ...
      var container = U("div", _defineProperty3(_defineProperty3({
    ...
    getModifiers: function getModifiers(options) {
      ...
      if (options.arg && _typeof3(options.arg) === "object") {
