      ...
      return [r].flat().reduce((s4, a2) => {
        if (a2 != null) {
          ...
          if (u === "string" || u === "number") s4.push(a2);
            ...
            s4 = p.length ? s4.concat(p.filter((f) => !!f)) : s4;
          }
        }
        return s4;
      }, i2);
  ...
  function r(n, l2) {
    ...
    for (; c3 <= n.length; ) {
      ...
      if ((g3 === '"' || g3 === "'" || g3 === "`") && n[c3 - 1] !== "\\" && (d2 = d2 === g3 ? null : g3), !d2 && (g3 === "(" && u++, g3 === ")" && u--, (g3 === "," || c3 === n.length) && u === 0)) {
        let f = m2.trim();
        f.startsWith("dt(") ? o.push(le(f, l2)) : o.push(s4(f)), m2 = "", c3++;
        continue;
      }
      g3 !== void 0 && (m2 += g3), c3++;
    }
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g3 = m2[u], f = ve(g3), p = G(u, a2) ? Q2(d2) : Q2(d2, re(u));
      if (i(f)) o.push({ node: f, path: p });
      else {
        let y2 = ae2(p), R2 = Y2(f, p, s4, [a2]);
        Re(l2, y2, R2);
        let T2 = p;
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M2 } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v2(u, ["dark"]), g3 = M2 || {}, { dark: te } = g3, re2 = v2(g3, ["dark"]), K2 = s2(O) ? this._toVariables({ [y2]: h2(h2({}, O), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y2]: h2(h2({}, L), re2) }, r) : {}, X = s2(V) ? this._toVariables({ [y2]: h2(h2({}, V), te) }, r) : {}, [G2, U2] = [(f = K2.declarations) != null ? f : "", K2.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
...
var S = { defaults: { variable: { prefix: "p", selector: ":root,:host", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $3(h2({}, t2), { options: h2(h2({}, this.defaults.options), t2.options) }), this._tokens = b.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = $3(h2({}, this.theme), { preset: e }), this._tokens = b.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N2.emit("preset:change", e), N2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
...
//# sourceMappingURL=chunk-O7MGO4SZ.js.map
